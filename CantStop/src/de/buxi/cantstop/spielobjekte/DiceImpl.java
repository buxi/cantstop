...
public class DiceImpl implements Dice {
	...
	/* (non-Javadoc)
	 * @see de.buxi.cantstop.spielobjekte.Dice#isThrown()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.buxi.cantstop.spielobjekte.Dice#getDiceValue()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.buxi.cantstop.spielobjekte.Dice#throwDice()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.buxi.cantstop.spielobjekte.Dice#reset()
	 */
	@Override
	public void reset() {
		setThrown(false);
